...
(N'Adrenalina (Epinefrina)', 0, 1, NULL),
(N'Anexate', 0, 1, NULL),
(N'Atropina', 2, 1, NULL),
(N'Actocortina 100 mg', 1, 1, NULL),
(N'Benerva (Tiamina)', 1, 1, NULL),
(N'Dormicum (Midazolam)', 0, 1, NULL),
...
(N'Aleudrina amp (Isoprenalina 0,2mg amp)', 0, 2, NULL),
...
(N'Clexane 80mg amp (Enoxaparina 80mg amp)', 0, 2, NULL),
...
(N'Inyesprin (Acetil salicilato de lisina 900mg)', 0, 2, NULL),
(N'Kepra amp (Levetiracetam 100mg/ml)', 0, 2, NULL),
...
(N'Paracetamol supositorio', 0, 2, NULL),
...
(N'Suplecal 10ml amp (Gluconato calcico 10ml)', 0, 2, NULL),
(N'Tinispray (Nitroglicerina 400mcg spray)', 2, 2, NULL),
(N'Toradol amp (Ketorolaco 50mg vial)', 4, 2, NULL),
(N'Trandate amp (Labetalol 100mg amp)', 0, 2, NULL),
(N'Trangorex (Amiodarona 150mg amp)', 1, 2, NULL),
(N'Tranxilium 20mg amp (Clorazepato dipotasico 20mg vial)', 0, 2, NULL),
...
(N'Zantac 50mg amp (Ranitidina 50mg amp)', 0, 2, NULL),
(N'Omeoprazol ampolla', 0, 2, NULL);
...
(N'Propofol (Propofol)', 0, 4, NULL),
(N'Dolantina', 2, 4, NULL),
(N'Ventolin 0,5 mg', 0, 4, NULL),
(N'Adrenalina precargada', 0, 4, NULL),
...
(N'Anectine (Suxametonio 100mg/2ml)', 0, 5, NULL),
...
(N'Mascarilla laringea 1', 0, 6, NULL),
(N'Guedel 1', 1, 6, NULL),
...
(N'Esponja hemostatica', 0, 7, NULL),
(N'Guedel 7', 1, 7, NULL),
(N'Guedel 8', 1, 7, NULL),
...
(N'Mascarilla nebulizador', 0, 8, NULL),
...
(N'Burnshield hidrogel 200X450', 0, 10, NULL),
...
(N'Sonda Foley 18', 0, 11, 6),
(N'Sonda Foley 20', 0, 11, 6),
...
(N'Silko gel', 1, 11, 8),
(N'Silkospray', 1, 11, 8),
(N'KIT INTUBACION PEDIATRICO', 0, 11, 8),
...
(N'Venda gasa 10x10', 0, 12, 16),
(N'Venda gasa 5x7', 0, 12, 16);
