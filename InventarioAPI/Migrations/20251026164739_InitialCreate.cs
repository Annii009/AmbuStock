...
namespace RetoCruzRoja.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "InventariosBase",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AmbulanciaId = table.Column<int>(type: "int", nullable: false),
                    ItemInventarioId = table.Column<int>(type: "int", nullable: false),
                    CantidadMinima = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InventariosBase", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InventariosBase_Ambulancias_AmbulanciaId",
            ...
            migrationBuilder.CreateIndex(
                ...
                columns: new[] { "AmbulanciaId", "ItemInventarioId" },
                unique: true);
